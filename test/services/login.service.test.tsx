...
global.fetch = jest.fn().mockImplementation(() =>
  Promise.resolve({
    json: () =>
      Promise.resolve({
        accessToken:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQHN5c3RlcnMueHl6IiwiaWF0IjoxNzAwMTg0MjgyLCJleHAiOjE3MDAxODc4ODIsInN1YiI6IjEifQ.Zg7nE0dHqpcMM--WwJnEJCeiarkSp5pMk1i-ln0M0Lo",
        user: {
