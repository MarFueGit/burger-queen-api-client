...
import PedidosListos from "../../src/components/PedidosListos";
...
describe("PedidosListos components", () => {
  ...
  it("Renderizame los pedidos listos ", async () => {
    //Prepare
    ...
    // actuar
    fireEvent.click(getAllByText("Marcar como entregada")[0]);
// Assert
    expect(getAllByText(/done/)).not.toBeNull();
  });

  it("error al obtener las ordenes de pedidos listos", () => {
